...
def plot_results(
    ...
    tt= {'ddpo':'P3O','vpgdualclip':'Dual-Clip PPO',
         ...
         'vpgsigmoid':'P3O-K','vpg':'P3O-KS','vpgkl':'P3O-S',
         "ddpodeepNN":'P3O+deeper network'}
...
if __name__ == '__main__':
    path = [
        # '/home/chenxing/extra_test',
        #     '/home/chenxing/DDPO/extra_test_8opt',
        # '/home/chenxing/DDPO/extra_test_ablation',
        # '/home/chenxing/DDPO/image/performence'
        #    "/home/chenxing/ubt/DDPO/extra_test_depth_network",
        "/home/chenxing/DDPO/ewai_trpo_acktr_duaclip/extra_test"
            ]
    ...
    plot_results(results, split_fn=group_by_name, group_fn=group_by_seed, average_group=True,
                           ...
                           ylabel=Y_REWARD,row=1, col=3)
    # plt.show()
    fig = plt.gcf()
    save_name = 'extra_test_depth_network2'

...
@register("mlp")
def mlp(num_layers=2, num_hidden=64, activation=tf.tanh, layer_norm=False,**kwargs):
    """
...
@register("squash_mlp")
def squash_mlp(num_layers=2, num_hidden=64, activation=tf.nn.relu, layer_norm=False):
    """
    Stack of fully-connected layers to be used in a policy / q-function approximator
